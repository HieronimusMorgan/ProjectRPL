        ...
        if (session.getAttribute("idPostingan") == null) {
            ...
            if (a.cekUser(pengguna)) {
                ...
                out.print("<html>\n"
                        ...
                        + "\n"
                        + "<body>\n"
                        + "<div class=\"modal fade\" id=\"contohModal\" role=\"dioalog\" aria-labelledby=\"modalLabel\" aria-hidden=\"true\">\n"
                        + "            <div class=\"modal-dialog\" role=\"document\">\n"
                        + "                <div class=\"modal-content\">\n"
                        + "                    <div class=\"modal-header\">\n"
                        + "                        <h5 class=\"modal-title\">HAPUS POSTNGAN</h5>\n"
                        ...
                        + "</div>\n "
                        + "<input class=\"btn btn-primary\" type=\"submit\" value=\"Hapus Postingan\" data-toggle=\"modal\" data-target=\"#contohModal\">\n"
                        + "<br><br>"
                        + "<div class=\"form-group\">\n"
                        + "<textarea class=\"form-control rounded-0\" form=\"usrform\"  rows=\"3\" name=\"komentar\" placeholder=\"Tulis komen disini ...\"></textarea>\n"
                        + "</div>\n"
