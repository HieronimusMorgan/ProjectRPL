 ...
 * @author Asus
 */
@WebServlet(urlPatterns = {"/Akun"})
public class Akun extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.print("<html>\n"
                ...
                + "<a class=\"active\" class=\"text-white\" href=\"Akun\">Akun</a>\n"
        ...
        out.print("<html>\n"
                ...
                + "<p>Password</p>\n"
                + "<input type=\"text\" name=\"nama\" value=\"" + pass + "\" disabled>\n"
                + "<br>"
